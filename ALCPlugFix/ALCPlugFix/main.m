...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        NSString *output1 = [@"hda-verb 0x12 SET_PIN_WIDGET_CONTROL 0x24" runAsCommand];
        NSString *output2 = [@"hda-verb 0x14 SET_UNSOLICITED_ENABLE 0x82" runAsCommand];
        ...
        AudioObjectAddPropertyListenerBlock(defaultDevice, &sourceAddr, dispatch_get_global_queue (DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^(UInt32 inNumberAddresses, const AudioObjectPropertyAddress * inAddresses) {
            ...
            if (bDataSourceId == 'ispk') {
                ...
                NSString *output1 = [@"hda-verb 0x19 SET_PIN_WIDGET_CONTROL 0x24" runAsCommand];
